...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2023 a las 20:59:02
...
--
-- Base de datos: `pt04_angel_tarensi`
--
DROP DATABASE IF EXISTS `pt04_angel_tarensi`;
CREATE DATABASE IF NOT EXISTS `pt04_angel_tarensi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pt04_angel_tarensi`;
...
(7, 'atarensi', 'a.tarensi2@sapalomera.cat', '$2y$10$7GgTQfOCPGtXZ7dwq1QlEuBJUQvIx3iStcpa8DvVpkZiXAQCOAKTu'),
(8, 'prova', 'atarensi@gmail.com', '$2y$10$1AsuL8i6z/mDTrkfPiCs7eOTPMwOZ7TyqBH7bndqD18Vj6Hw6twM6'),
(9, 'prova2', 'testdevirusyprovas@gmail.com', '$2y$10$Z4Bm.Zqvz24OFQ7tXdiQ.e0qlzdWccPbhwhQzvDCHMTYHx97DhVlq');
